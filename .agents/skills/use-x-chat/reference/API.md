...
| --------------------------- | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------ | ---- |
| abort                       | 取消请求                                                  | () => void                                                                                                    | -      | -    |
| isRequesting                | 是否在请求中（Vue Ref）                                   | Ref\<boolean\>                                                                                                | -      | -    |
| isDefaultMessagesRequesting | 默认消息列表是否在请求中（Vue Ref）                       | Ref\<boolean\>                                                                                                | false  | -    |
| messages                    | 当前管理消息列表的内容（Vue Ref）                         | Ref\<MessageInfo\<ChatMessage\>[]\>                                                                           | -      | -    |
| parsedMessages              | 经过 `parser` 转译过的内容（Vue Ref）                     | Ref\<MessageInfo\<ParsedMessages\>[]\>                                                                        | -      | -    |
