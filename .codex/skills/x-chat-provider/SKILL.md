...
- [📦 技术栈概览](#-技术栈概览)
  - [Antdv Next X 生态](#antdv-next-x-生态)
  - [核心概念](#核心概念)
- [🚀 快速开始](#-快速开始)
  - [依赖管理](#依赖管理)
...
> ```ts
> // ✅ 正确导入示例
> import { Bubble } from "@antdv-next/x"; // UI组件
> import { AbstractChatProvider } from "@antdv-next/x-sdk"; // Provider基类
> import { XRequest } from "@antdv-next/x-sdk"; // 请求工具
> ```
...
- [custom-provider-width-ui.tsx](https://github.com/antdv-next/x/blob/main/packages/docs/src/pages/sdk/demo/chat-provider-with-ui.vue) - 自定义 Provider 完整示例
